...
class ESP32_S3_1_28_BOX : public WifiBoard {
private:
    ...
    static void touchpad_timer_callback(void* arg) {
        auto& board = (ESP32_S3_1_28_BOX&)Board::GetInstance();
...
public:
    ESP32_S3_1_28_BOX() : boot_button_(BOOT_BUTTON_GPIO) {
...
DECLARE_BOARD(ESP32_S3_1_28_BOX);
